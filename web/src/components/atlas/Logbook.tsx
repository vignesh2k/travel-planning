      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[18px]">
        {visible.map((t) => {
          ...
          return (
            <div
              key={t.id}
              className="group relative pl-3 flex flex-col gap-1"
            ...
            >
              ...
              >
                <div className="flex items-baseline justify-between gap-2">
                  <span
                    className="truncate hover:text-[var(--color-terracotta-500)] transition-colors"
                    style={{
                      fontSize: 14,
                      fontWeight: 500,
              ...
              {/* Delete affordance */}
              <div className="absolute right-0 top-0 flex items-center gap-1.5 text-[11px]">
                {!isConfirming ? (
                  <button
                    type="button"
